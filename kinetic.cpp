...
void BCMainWindow::on_RunBlank_Btn_3_clicked()
{
...
void BCMainWindow::plot_kinetic_blnk()
{
    line=7;

}

void BCMainWindow::on_RunCal_Btn_3_clicked()
{
    option=3;
    clearGraph_end();
...
void BCMainWindow::plot_kinetic_calibrate()
{
    line=8;
}

void BCMainWindow::on_Save_Btn_7_clicked()
{
    QMessageBox msgBox;
    QSqlQuery query;
...
void BCMainWindow::on_RunSample_Btn_3_clicked()
{
    option=4;
    clearGraph_end();
    ...
    QString wavelength , intensity ;
    double blankval = 0 ,  con1=0, mulfact =0, fact = 0;
    int read = 0 ,lag =0, dely = 0  ;
    QString TestName = ui->TestName_Lbl_6->text();
    QSqlQuery query;
    query.prepare("select * from test where name = '"+TestName+"'");
...
void BCMainWindow::plot_kinetic()
{
    line=9;
}

int BCMainWindow::on_Print_Btn_3_clicked()
{
